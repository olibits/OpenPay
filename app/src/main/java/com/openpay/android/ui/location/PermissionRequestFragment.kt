...
import com.openpay.android.BuildConfig
import com.openpay.android.R
import com.openpay.android.databinding.FragmentPermissionRequestBinding
import com.openpay.android.utils.hasPermission
import com.openpay.android.utils.requestPermissionWithRationale
...
class PermissionRequestFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.permissionRequestButton.setBackgroundColor(
            ContextCompat.getColor(
                binding.root.context,
                R.color.black
            )
        )
        binding.permissionRequestButton.setTextColor(
            ContextCompat.getColor(
                binding.root.context,
                R.color.white
            )
